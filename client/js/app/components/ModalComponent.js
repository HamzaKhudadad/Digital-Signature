        ...
        <div className={this.state.className}>
          <div className=" form-container sign-in-container">
            <form>
              ...
              <input name="remember" onChange={this.handleChange} value="1" type="checkbox"/>
          ...
          <div className="form-container sign-up-container">
              <form>
                ...
                <input type="email" placeholder="Email" name="email" onChange={this.handleChange}/>
                <input type="password" placeholder="Password" name="password" oonChange={this.handleChange}/>
                <button type='submit' onClick={this.handleLoginSubmit}>Sign Up</button>
              </form>
            </div>
            <div className="overlay-container">
              <div className="overlay">
                ...
                <button onClick={this.onClick} className="btn-overlay" id="signIn">
                  Sign In
                </button>
              </div>
              <div className="overlay-panel overlay-right">
                ...
                <button onClick={this.onClick} className="btn-overlay" id="signUp">
                  Sign Up
                </button>
              </div>
              </div>
